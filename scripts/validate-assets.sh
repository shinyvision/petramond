...
"${cargo_cmd[@]}" test --profile playtest -p petramond-world --lib shipped_
"${cargo_cmd[@]}" test --profile playtest -p petramond-world --lib \
    block_model::tests::every_registered_model_compiles_with_geometry_and_texture -- --exact
"${cargo_cmd[@]}" test --profile playtest -p petramond --lib \
...
"${cargo_cmd[@]}" test --profile playtest -p petramond-render --lib \
