//! wheel — the wheel-of-fortune proof-of-concept mod (WIKI/modding.md), the
...
const SPIN_SOUND: &str = "chest_open";
const LAND_SOUND: &str = "item_pickup";
