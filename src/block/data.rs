...
pub(super) const BLOCK_DEFS: &[BlockDef] = &[
    ...
    BlockDef {
        ...
        tags: &[
            BlockTag::Fragile,
            BlockTag::Replaceable,
            BlockTag::RootsInSoil,
        ],
        behavior: &behavior::FRAGILE,
        interaction: BlockInteraction::None,
        flags: PLANT_FLAGS,
    ...
    BlockDef {
        ...
        tags: &[],
        behavior: &behavior::INERT,
        interaction: BlockInteraction::OpenCraftingTable,
        flags: FULL_CUBE_FLAGS,
    ...
    BlockDef {
        ...
        tags: &[],
        behavior: &behavior::INERT,
        interaction: BlockInteraction::OpenFurnace,
    ...
    BlockDef {
        ...
        tags: &[],
        behavior: &behavior::INERT,
        interaction: BlockInteraction::OpenChest,
    ...
    BlockDef {
        ...
        tags: &[],
        behavior: &behavior::INERT,
        interaction: BlockInteraction::OpenFurnitureWorkbench,
    ...
    BlockDef {
        ...
        interaction: BlockInteraction::ToggleDoor,
        flags: DOOR_FLAGS,
    ...
    BlockDef {
        ...
        interaction: BlockInteraction::ToggleDoor,
        flags: DOOR_FLAGS,
        tiles: [Tile::BirchDoorTop, Tile::BirchDoorBottom, Tile::BirchPlanks],
        material: BlockMaterial::Wood,
        harvest_tier: 0,
        hardness: 3.0,
    ...
    BlockDef {
        ...
        interaction: BlockInteraction::None,
        flags: FULL_CUBE_FLAGS,
        tiles: [Tile::RedwoodLogTop, Tile::RedwoodLogTop, Tile::RedwoodLogSide],
        material: BlockMaterial::Wood,
        harvest_tier: 0,
        hardness: 2.0,
        drop: drops_self!(RedwoodLog),
    },
    BlockDef {
        block: Block::RedwoodLeaves,
        shape: RenderShape::Cube,
        collision: FULL_CUBE_BOXES,
        emission: 0,
        tags: &[BlockTag::Leaves, BlockTag::NoGrassDecay],
        ...
        interaction: BlockInteraction::None,
        flags: LEAVES_FLAGS,
        tiles: [Tile::RedwoodLeaves, Tile::RedwoodLeaves, Tile::RedwoodLeaves],
        material: BlockMaterial::Foliage,
        harvest_tier: 0,
        hardness: 0.2,
        // No redwood sapling (giant worldgen tree, no sapling asset), so leaves
        // shed no sapling — like azalea/mangrove leaves.
        drop: DropSpec::NONE,
    },
    BlockDef {
        block: Block::RedwoodPlanks,
        shape: RenderShape::Cube,
        collision: FULL_CUBE_BOXES,
        emission: 0,
        tags: &[],
        ...
        interaction: BlockInteraction::None,
        flags: FULL_CUBE_FLAGS,
        tiles: [Tile::RedwoodPlanks, Tile::RedwoodPlanks, Tile::RedwoodPlanks],
        material: BlockMaterial::Wood,
        harvest_tier: 0,
        hardness: 2.0,
        drop: drops_self!(RedwoodPlanks),
    },
    BlockDef {
        block: Block::RedwoodDoor,
        shape: RenderShape::Door,
        collision: crate::door::DEFAULT_BOXES,
        emission: 0,
        tags: &[BlockTag::NoGrassDecay],
