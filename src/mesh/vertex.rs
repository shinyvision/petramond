...
pub(crate) const TINT_ALPHA_SHIFT: u32 = 24;
...
#[inline]
pub(crate) fn retint(tint_word: u32, rgb: [f32; 3]) -> u32 {
...
pub(crate) const CHROMA_HI_SHIFT: u32 = 27;
pub(crate) const CHROMA_HI_MASK: u32 = 0xF;
...
impl BlockLight6 {
    ...
    #[inline]
    pub(crate) fn packed2_bits(self) -> u32 {
    ...
    #[inline]
    pub(crate) fn tint_word(self, rgb: [f32; 3]) -> u32 {
...
#[cfg(test)]
#[inline]
pub(crate) fn decode_vertex_light(v: &Vertex) -> BlockLight6 {
...
pub(crate) const BLOCK_LIGHT_MASK: u32 = 0x3F;
...
pub(crate) const NORMAL_CODE_SHIFT: u32 = 16;
pub(crate) const NORMAL_CODE_MASK: u32 = 0x7;
...
pub(crate) const CELL_UV_U_SHIFT: u32 = 6;
pub(crate) const CELL_UV_V_SHIFT: u32 = 11;
pub(crate) const CELL_UV_MASK: u32 = 0x1F;
