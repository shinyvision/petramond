...
impl ItemType {
    ...
    pub const Marble: ItemType = ItemType(45);
    pub const Tuff: ItemType = ItemType(46);
    pub const CoalOre: ItemType = ItemType(47);
    pub const IronOre: ItemType = ItemType(48);
    pub const CopperOre: ItemType = ItemType(49);
    pub const GoldOre: ItemType = ItemType(50);
    pub const DiamondOre: ItemType = ItemType(51);
    pub const Pumpkin: ItemType = ItemType(52);
    pub const Melon: ItemType = ItemType(53);
    pub const Cactus: ItemType = ItemType(54);
    pub const ShortGrass: ItemType = ItemType(55);
    pub const Fern: ItemType = ItemType(56);
    pub const Dandelion: ItemType = ItemType(57);
    pub const Poppy: ItemType = ItemType(58);
    pub const Cornflower: ItemType = ItemType(59);
    pub const Allium: ItemType = ItemType(60);
    pub const AzureBluet: ItemType = ItemType(61);
    pub const OxeyeDaisy: ItemType = ItemType(62);
    pub const RedTulip: ItemType = ItemType(63);
    pub const DeadBush: ItemType = ItemType(64);
    pub const BrownMushroom: ItemType = ItemType(65);
    pub const RedMushroom: ItemType = ItemType(66);
    pub const Cobblestone: ItemType = ItemType(67);
    pub const OakPlanks: ItemType = ItemType(68);
    pub const SprucePlanks: ItemType = ItemType(69);
    pub const BirchPlanks: ItemType = ItemType(70);
    pub const JunglePlanks: ItemType = ItemType(71);
    pub const AcaciaPlanks: ItemType = ItemType(72);
    pub const DarkOakPlanks: ItemType = ItemType(73);
    pub const CherryPlanks: ItemType = ItemType(74);
    pub const MangrovePlanks: ItemType = ItemType(75);
    pub const CraftingTable: ItemType = ItemType(76);
    pub const Stick: ItemType = ItemType(77);
    pub const WoodenPickaxe: ItemType = ItemType(78);
    pub const StonePickaxe: ItemType = ItemType(79);
    pub const RawIron: ItemType = ItemType(80);
    pub const RawCopper: ItemType = ItemType(81);
    pub const Coal: ItemType = ItemType(82);
    pub const IronIngot: ItemType = ItemType(83);
    pub const CopperIngot: ItemType = ItemType(84);
    pub const Furnace: ItemType = ItemType(85);
    pub const Chest: ItemType = ItemType(86);
    pub const Torch: ItemType = ItemType(87);
    pub const Diamond: ItemType = ItemType(88);
    pub const RawGold: ItemType = ItemType(89);
    pub const GoldIngot: ItemType = ItemType(90);
    pub const WoodenAxe: ItemType = ItemType(91);
    pub const StoneAxe: ItemType = ItemType(92);
    pub const IronAxe: ItemType = ItemType(93);
    pub const DiamondAxe: ItemType = ItemType(94);
    pub const IronPickaxe: ItemType = ItemType(95);
    pub const DiamondPickaxe: ItemType = ItemType(96);
    pub const WoodenShovel: ItemType = ItemType(97);
    pub const StoneShovel: ItemType = ItemType(98);
    pub const IronShovel: ItemType = ItemType(99);
    pub const DiamondShovel: ItemType = ItemType(100);
    pub const FurnitureWorkbench: ItemType = ItemType(101);
    pub const OakSapling: ItemType = ItemType(102);
    pub const SpruceSapling: ItemType = ItemType(103);
    pub const BirchSapling: ItemType = ItemType(104);
    pub const JungleSapling: ItemType = ItemType(105);
    pub const AcaciaSapling: ItemType = ItemType(106);
    pub const DarkOakSapling: ItemType = ItemType(107);
    pub const CherrySapling: ItemType = ItemType(108);
    pub const OakDoor: ItemType = ItemType(109);
    pub const SpruceDoor: ItemType = ItemType(110);
    pub const BirchDoor: ItemType = ItemType(111);
    pub const JungleDoor: ItemType = ItemType(112);
    pub const AcaciaDoor: ItemType = ItemType(113);
    pub const DarkOakDoor: ItemType = ItemType(114);
    pub const CherryDoor: ItemType = ItemType(115);
    pub const MangroveDoor: ItemType = ItemType(116);
    pub const RedwoodLog: ItemType = ItemType(117);
    pub const RedwoodLeaves: ItemType = ItemType(118);
    pub const RedwoodPlanks: ItemType = ItemType(119);
    pub const RedwoodDoor: ItemType = ItemType(120);
    pub const OakStairs: ItemType = ItemType(121);
    pub const SpruceStairs: ItemType = ItemType(122);
    pub const BirchStairs: ItemType = ItemType(123);
    pub const JungleStairs: ItemType = ItemType(124);
    pub const AcaciaStairs: ItemType = ItemType(125);
    pub const DarkOakStairs: ItemType = ItemType(126);
    pub const CherryStairs: ItemType = ItemType(127);
    pub const MangroveStairs: ItemType = ItemType(128);
    pub const RedwoodStairs: ItemType = ItemType(129);
    pub const CobblestoneStairs: ItemType = ItemType(130);
    pub const StoneStairs: ItemType = ItemType(131);
    pub const DirtStairs: ItemType = ItemType(132);
    pub const WoodenBucket: ItemType = ItemType(133);
    pub const WaterBucket: ItemType = ItemType(134);
    pub const Shears: ItemType = ItemType(135);
    pub const Wool: ItemType = ItemType(136);
    pub const BedFrame: ItemType = ItemType(137);
    pub const Bed: ItemType = ItemType(138);
    pub const OakSlab: ItemType = ItemType(139);
    pub const SpruceSlab: ItemType = ItemType(140);
    pub const BirchSlab: ItemType = ItemType(141);
    pub const JungleSlab: ItemType = ItemType(142);
    pub const AcaciaSlab: ItemType = ItemType(143);
    pub const DarkOakSlab: ItemType = ItemType(144);
    pub const CherrySlab: ItemType = ItemType(145);
    pub const MangroveSlab: ItemType = ItemType(146);
    pub const RedwoodSlab: ItemType = ItemType(147);
    pub const CobblestoneSlab: ItemType = ItemType(148);
    pub const StoneSlab: ItemType = ItemType(149);
