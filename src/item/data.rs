...
pub(crate) const ENGINE_ITEM_NAMES: &[&str] = &[
    ...
    "petramond:dark_oak_log",
    "petramond:cherry_log",
    "petramond:mangrove_log",
    "petramond:spruce_leaves",
    "petramond:birch_leaves",
    "petramond:jungle_leaves",
    "petramond:acacia_leaves",
    "petramond:dark_oak_leaves",
    "petramond:mangrove_leaves",
    "petramond:cherry_leaves",
    ...
    "petramond:gold_ore",
    "petramond:redstone_ore",
    "petramond:lapis_ore",
    "petramond:diamond_ore",
    "petramond:emerald_ore",
    "petramond:pumpkin",
    "petramond:melon",
    "petramond:cactus",
    ...
    "petramond:dark_oak_planks",
    "petramond:cherry_planks",
    "petramond:mangrove_planks",
    ...
    "petramond:dark_oak_sapling",
    "petramond:cherry_sapling",
    "petramond:oak_door",
    "petramond:spruce_door",
    "petramond:birch_door",
    "petramond:jungle_door",
    "petramond:acacia_door",
    "petramond:dark_oak_door",
    "petramond:cherry_door",
    "petramond:mangrove_door",
    ...
    "petramond:dark_oak_stairs",
    "petramond:cherry_stairs",
    "petramond:mangrove_stairs",
    ...
    "petramond:dark_oak_slab",
    "petramond:cherry_slab",
    "petramond:mangrove_slab",
