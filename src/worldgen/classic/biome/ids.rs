...
pub fn category(id: i32) -> i32 {
    match id {
        ...
        BADLANDS | WOODED_BADLANDS_PLATEAU | BADLANDS_PLATEAU | ERODED_BADLANDS
        | MODIFIED_WOODED_BADLANDS_PLATEAU | MODIFIED_BADLANDS_PLATEAU => BADLANDS,
        ...
        | GIANT_TREE_TAIGA_HILLS | TAIGA_MOUNTAINS | SNOWY_TAIGA_MOUNTAINS | GIANT_SPRUCE_TAIGA
