...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_630_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_630_4: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_631: (a: number, b: number) => void;
