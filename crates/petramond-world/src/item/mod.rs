...
impl ItemType {
    ...
    pub const Pebble: ItemType = ItemType(69);
    pub const Hemp: ItemType = ItemType(70);
    pub const Rope: ItemType = ItemType(71);
    pub const StonePickaxe: ItemType = ItemType(72);
    pub const RawIron: ItemType = ItemType(73);
    pub const RawCopper: ItemType = ItemType(74);
    pub const Coal: ItemType = ItemType(75);
    pub const IronIngot: ItemType = ItemType(76);
    pub const CopperIngot: ItemType = ItemType(77);
    pub const Furnace: ItemType = ItemType(78);
    pub const Chest: ItemType = ItemType(79);
    pub const Torch: ItemType = ItemType(80);
    pub const Diamond: ItemType = ItemType(81);
    pub const RawGold: ItemType = ItemType(82);
    pub const GoldIngot: ItemType = ItemType(83);
    pub const StoneAxe: ItemType = ItemType(84);
    pub const IronAxe: ItemType = ItemType(85);
    pub const DiamondAxe: ItemType = ItemType(86);
    pub const IronPickaxe: ItemType = ItemType(87);
    pub const DiamondPickaxe: ItemType = ItemType(88);
    ...
    pub const Bed: ItemType = ItemType(120);
    pub const OakSlab: ItemType = ItemType(121);
    pub const SpruceSlab: ItemType = ItemType(122);
    pub const BirchSlab: ItemType = ItemType(123);
    pub const JungleSlab: ItemType = ItemType(124);
    pub const AcaciaSlab: ItemType = ItemType(125);
    pub const RedwoodSlab: ItemType = ItemType(126);
    pub const CobblestoneSlab: ItemType = ItemType(127);
    pub const StoneSlab: ItemType = ItemType(128);
    pub const DirtSlab: ItemType = ItemType(129);
    pub const Glass: ItemType = ItemType(130);
    pub const GlassPane: ItemType = ItemType(131);
    pub const WoolBlock: ItemType = ItemType(132);
    pub const WoolStairs: ItemType = ItemType(133);
    pub const WoolSlab: ItemType = ItemType(134);
    pub const PolishedMarble: ItemType = ItemType(135);
    pub const MarbleStairs: ItemType = ItemType(136);
    pub const MarbleSlab: ItemType = ItemType(137);
    pub const PolishedMarbleStairs: ItemType = ItemType(138);
    pub const PolishedMarbleSlab: ItemType = ItemType(139);
    pub const Ladder: ItemType = ItemType(140);
    pub const OakFence: ItemType = ItemType(141);
    pub const SpruceFence: ItemType = ItemType(142);
    pub const BirchFence: ItemType = ItemType(143);
