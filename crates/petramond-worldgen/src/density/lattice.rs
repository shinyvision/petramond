...
pub struct DensityLatticeCellSize {
    x: usize,
    y: usize,
    z: usize,
}
...
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub struct DensityLatticeBounds {
    origin_x: i32,
    origin_y: i32,
    origin_z: i32,
    size_x: usize,
...
impl DensityLatticeBounds {
    ...
    #[cfg(test)]
    pub fn chunk(cx: i32, cz: i32) -> Self {
        Self::new(
            cx * CHUNK_SX as i32,
            0,
            cz * CHUNK_SZ as i32,
    ...
    #[cfg(test)]
    pub fn world_z(self, local_z: usize) -> i32 {
        assert!(
            local_z < self.size_z,
    ...
    #[cfg(test)]
    pub fn local_index(self, x: usize, y: usize, z: usize) -> usize {
        assert!(
...
impl DensityLattice {
    ...
    #[cfg(test)]
    pub const fn bounds(&self) -> DensityLatticeBounds {
        self.bounds
    }

    #[cfg(test)]
    pub const fn cell_size(&self) -> DensityLatticeCellSize {
        self.cell
    }

    #[cfg(test)]
    pub fn sample_counts(&self) -> (usize, usize, usize) {
        (
            self.sample_x.count,
            self.sample_y.count,
            self.sample_z.count,
    ...
    #[cfg(test)]
    pub fn sample_world_origin(&self) -> (i32, i32, i32) {
        (
    ...
    #[cfg(test)]
    pub fn density_at_local(&self, x: usize, y: usize, z: usize) -> f64 {
    ...
    #[cfg(test)]
    pub fn density_at_world(&self, wx: i32, wy: i32, wz: i32) -> f64 {
        assert!(
    ...
    #[cfg(test)]
    pub fn solid_at_local(&self, x: usize, y: usize, z: usize) -> bool {
        density_is_solid(self.density_at_local(x, y, z))
    }

    #[cfg(test)]
    pub fn for_each_solid(&self, mut visit: impl FnMut(usize, usize, usize, bool)) {
    ...
    #[cfg(test)]
    pub fn top_solid_surface(&self, x: usize, z: usize) -> Option<i32> {
        assert!(
    ...
    pub fn top_solid_surfaces(&self) -> Vec<Option<i32>> {
        let bounds = self.bounds;
...
pub fn density_is_solid(density: f64) -> bool {
    density > 0.0
}
