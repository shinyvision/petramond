...
const TILES: &[(&str, &str)] = &[
    ...
    ("redwood_log_top", "redwood_log_top.png"),
    ("redwood_log_side", "redwood_log.png"),
    ("redwood_leaves", "redwood_leaves.png"),
    ("redwood_planks", "redwood_planks.png"),
    ("redwood_door_top", "redwood_door_top.png"),
    ("redwood_door_bottom", "redwood_door_bottom.png"),
    ("redwood_door_item", "redwood_door_item.png"),
