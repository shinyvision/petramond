...
const PINS: &[(&str, &str)] = &[
    ...
    ("HostCall::MobTagGet", "2107036d3a6b"),
    ("HostCall::MobTagSet", "2207036d3a6b0105"),
    ("HostCall::MobTagDelete", "2307036d3a6b"),
    ("HostCall::ResolveBlock", "24036d3a62"),
    ("HostCall::RegisterWorldgenFeature", "250104"),
    ("HostCall::RegisterStageReplacement", "260102"),
    ("HostCall::RegisterGenerator", "2703"),
    ("HostCall::GuiStateSet", "28016b0102"),
    ("HostCall::GuiStateGet", "29016b"),
    ("HostCall::GuiOpen", "2a036d3a67"),
    ("HostCall::GuiClose", "2b"),
    ("HostCall::ChatSend", "2c0174010101"),
    ("HostCall::SoundPlayAt", "2d036d3a730000803f00000040000040400000803f0000803f"),
    ("HostCall::SoundPlayOnMob", "2e01036d3a730000803f0000803f"),
    ("HostCall::SoundStop", "2f01"),
    ("HostCall::ShaderSetParam", "30036d3a70000000000000803e0000003f0000803f"),
    ("HostCall::RegisterHostileSpawner", "310104"),
    ("HostCall::RegisterBlockBehavior", "32036d3a6201"),
    ("HostCall::RegisterAiNode", "33036d3a6e02"),
    ("HostCall::ContainerGet", "34020406"),
    ("HostCall::ContainerSet", "35020406020001036d3a69010100"),
    ("HostCall::ItemInfo", "36036d3a69"),
    ("HostCall::RecipeResult", "37036d3a63036d3a69"),
    ("HostCall::EffectApply", "38036d3a6505"),
    ("HostCall::EffectsActive", "39"),
    ("HostCall::SwapModelBlock", "3a02040606"),
    ("HostCall::ContainerGetMany", "3b01020406"),
    ("HostCall::MobEmitterSet", "3c07036d3a6501"),
    ...
    ("HostCall::ReplaceHeldOne", "5403036d3a69"),
    ("HostCall::MobMount", "55070100"),
    ("HostCall::MobDismount", "5601"),
    ("HostCall::MobRiders", "5707"),
    ("HostCall::MobDrive", "58070000803f00000040010000003f"),
    ("HostCall::MobAnimSet", "590703726f7701"),
    ("HostCall::MobAnimRate", "5a0703726f77000080bf"),
    ("HostCall::MobAnimSeek", "5b0703726f770000c03f0000403f"),
    ("HostCall::PlayerInput", "5c01"),
    ("HostCall::MobAnimState", "5d0703726f77"),
    ...
    ("HostCall::ItemsByTag", "68036d3a74"),
    ("HostCall::BlockNames", "69020109"),
    ("HostCall::ItemNames", "6a020109"),
