...
const PINS: &[(&str, &str)] = &[
    ...
    ("HostCall::SpawnMob", "0c036d3a6b000000000000f03f000000000000004000000000000008400000003f01"),
    ("HostCall::MobsInRadius", "0d000000000000f03f0000000000000040000000000000084000008040"),
    ("HostCall::DamageMob", "0e070000004001000000000000f03f00000000000000400000000000000840010200050a010003"),
    ("HostCall::DespawnMob", "0f07"),
    ("HostCall::SpawnItem", "10036d3a6903000000000000f03f0000000000000040000000000000084000"),
    ("HostCall::PlayerState", "11"),
    ("HostCall::DamagePlayer", "12010401000000000000f03f00000000000000400000000000000840010109"),
    ...
    ("HostCall::Teleport", "16000000000000f03f00000000000000400000000000000840"),
    ("HostCall::EmitSound", "17036d3a7301000000000000f03f00000000000000400000000000000840"),
    ...
    ("HostCall::PlayerPoseSet", "7101000000000000f83f00000000000000400000000000000cc00000003f01"),
    ...
    ("HostCall::SetPlayerAttribute", "8e0103010000c03f"),
    ...
    ("GuestCall::ClientFrame", "08cdcc4c3d000000000000f03f000000000000004000000000000008400000003f0000803e8005e00301036d3a6700"),
    ...
    ("EventPayload::MobDamagePre", "040702000040400001000000000000f03f000000000000004000000000000008400600010000003f020000803f0000003f030004050a"),
    ...
    ("ItemUseEvent::*", "000102"),
    ("EventPayload::MobDied", "090701000000000000f03f00000000000000400000000000000840"),
    ...
    ("EventPayload::PlayerDismounted(anchor)", "110001000000000000f83f00000000000000400000000000000cc0"),
    ("EventPayload::MobTagAdded", "120702036d3a6b0105"),
    ("EventPayload::MobTagRemoved", "130702036d3a6b0105"),
    ("EventPayload::ItemPickedUp", "14010304000000000000f83f00000000000000400000000000000cc0"),
