...
const PINS: &[(&str, &str)] = &[
    ...
    ("HostCall::MobMount", "51070100"),
    ("HostCall::MobDismount", "5201"),
    ("HostCall::MobRiders", "5307"),
    ("HostCall::MobDrive", "54070000803f00000040010000003f"),
    ("HostCall::MobAnimSet", "550703726f7701"),
    ("HostCall::MobAnimRate", "560703726f77000080bf"),
    ("HostCall::MobAnimSeek", "570703726f770000c03f0000403f"),
    ("HostCall::PlayerInput", "5801"),
    ("HostCall::MobAnimState", "590703726f77"),
    ("HostCall::BiomeAt", "5a0203"),
    ("HostCall::SurfaceYAt", "5b0203"),
    ("HostCall::Players", "5c"),
    ("HostCall::ClientEnvParams", "5d01036d3a6b"),
    ("HostCall::ClientBiomeAt", "5e0203"),
    ("HostCall::ClientAmbientSet", "5f066d3a7261696e0000003f0000803f000000c0"),
    ("HostCall::ClientLoopSet", "60066d3a6c6f6f700000003f"),
    ("HostCall::ClientMoodSet", "610000803e0000003f"),
    ("HostCall::ClientBlocksAt", "6201020306"),
    ("HostCall::BlocksByTag", "63036d3a74"),
    ("HostCall::ItemsByTag", "64036d3a74"),
    ("HostCall::BlockNames", "65020109"),
    ("HostCall::ItemNames", "66020109"),
    ("HostCall::ResolveMob", "67036d3a6b"),
    ("HostCall::MobNames", "68020109"),
    ("HostCall::CollisionShapeAt", "69020406"),
    ("HostRet::Unit", "00"),
    ("HostRet::U64", "0101"),
